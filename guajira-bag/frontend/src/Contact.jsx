...
export default function Contact() {
  ...
  const cards = [
    ...
    },
    {
      icon: <MessageCircle />,
      title: "Email",
      content: "guajirabags01@gmail.com",
      delay: 0.3
    },
  ];

  const socials = [
    { name: "Instagram", icon: <Instagram size={20} />, url: "https://www.instagram.com/guajira_bags/", label: "Síguenos" },
    { name: "TikTok", icon: <TikTokIcon size={20} />, url: "https://www.tiktok.com/@.guajira.bags?is_from_webapp=1&sender_device=pc", label: "Síguenos" },
