    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div>
            <label style={labelStyle}>Código / NIT (opcional)</label>
            <input value={codigo} onChange={e => setCodigo(e.target.value)} placeholder="Ejem: GUAJ-0001" style={inputStyle} />
          </div>
    ...
    <div style={{ minHeight: '100vh', background: '#F6F0E7' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <span style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 17 }}>Guajira Bags</span>
